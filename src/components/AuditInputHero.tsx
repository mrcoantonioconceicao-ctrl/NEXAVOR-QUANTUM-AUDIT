...
export const AuditInputHero: React.FC<AuditInputHeroProps> = ({
  ...
  const [githubUrl, setGithubUrl] = useState('https://github.com/mrcoantonioconceicao-ctrl/Atolada-anchor');
              ...
              {showTokenInput && (
                <div className="p-3 rounded border border-zinc-800 bg-zinc-900/70 space-y-2">
                  ...
                  <input
                    ...
                    placeholder="ghp_xxxxxxxxxxxxxxxxxxxx (necessário apenas para repositórios privados ou limites de rate)"
