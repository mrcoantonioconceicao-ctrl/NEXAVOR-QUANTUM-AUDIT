              ...
              <div className="flex items-center gap-3 bg-zinc-900 px-3 py-1.5 rounded border border-zinc-800">
                <div className="flex items-center gap-1.5 text-xs font-mono">
                  ...
                  <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase ${
                    refactorResult.auditMetrics.status === 'APROVADO'
                      ? 'bg-emerald-500/20 text-emerald-400 border border-emerald-500/30'
                      : refactorResult.auditMetrics.status === 'NO_OP_REQUIRED'
                      ? 'bg-amber-500/20 text-amber-400 border border-amber-500/30'
                      : 'bg-red-500/20 text-red-400 border border-red-500/30'
                  }`}>
                    {refactorResult.auditMetrics.status}
                  </span>
                </div>
                <div className="flex items-center gap-1.5 text-xs font-mono">
                  <span className="text-zinc-500 font-bold uppercase">Clean Code & DDD:</span>
